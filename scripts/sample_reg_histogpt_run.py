...
with h5py.File('../running_dir/competitoin_data/save_folder/h5_files/256px_ctranspath_0.0mpp_4.0xdown_normal/2023-03-06 23.51.44.h5', 'r') as f:
    features = f['feats'][:]
...
slide_path = '../running_dir/competition/slide_folder/PIT_01_00002_01.tiff'
...
output_dir = "../outputs/competitoin-slide-output"
